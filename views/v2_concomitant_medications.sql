...
SELECT
    ...
    CASE
        ...
        THEN DATE_DIFF('day',
            DATE(TRY(from_iso8601_timestamp(ca.start_datetime))),
            DATE(TRY(from_iso8601_timestamp(ca.stop_datetime))))
        ELSE NULL
    ...
    CASE
        ...
        THEN DATE_DIFF('day',
            DATE(TRY(from_iso8601_timestamp(am.start_datetime))),
            DATE(TRY(from_iso8601_timestamp(am.stop_datetime))))
        ELSE NULL
