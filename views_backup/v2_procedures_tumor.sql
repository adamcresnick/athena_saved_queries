...
SELECT
    ...
    TRY(CAST(NULLIF(p.performed_period_start, '') AS TIMESTAMP(3))) as proc_performed_period_start,
    TRY(CAST(NULLIF(p.performed_period_end, '') AS TIMESTAMP(3))) as proc_performed_period_end,
    TRY(CAST(NULLIF(p.performed_string, '') AS TIMESTAMP(3))) as proc_performed_string,
    TRY(CAST(NULLIF(p.performed_age_value, '') AS TIMESTAMP(3))) as proc_performed_age_value,
    TRY(CAST(NULLIF(p.performed_age_unit, '') AS TIMESTAMP(3))) as proc_performed_age_unit,
